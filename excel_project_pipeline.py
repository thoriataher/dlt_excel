...
def load_api_data() -> None:
    ...
    pipeline = dlt.pipeline(
        pipeline_name="chess_pipeline", destination='filesystem', dataset_name="player_data"
    )
...
def load_data_from_source():
    pipeline = dlt.pipeline(
        pipeline_name="github_api_pipeline", destination='filesystem', dataset_name="github_api_data"
    )
